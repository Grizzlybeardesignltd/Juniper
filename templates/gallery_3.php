  ...
  <div class="gallery section-14">
    <div class="w-container">
      <div class="row-7 w-row">
        <div class="column-4 w-col w-col-4"><img class="image-54" sizes="(max-width: 767px) 94vw, (max-width: 991px) 229.328125px, 299.984375px" src="<?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257.jpg" srcset="<?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-500.jpeg 500w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-800.jpeg 800w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-1080.jpeg 1080w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-1600.jpeg 1600w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257.jpg 1920w">
        </div>
        <div class="column-5 w-col w-col-4"><img class="image-55" sizes="(max-width: 767px) 94vw, (max-width: 991px) 229.328125px, 299.984375px" src="<?php echo get_template_directory_uri();?>/images/068-351---Nuttall---D66A0488.jpg" srcset="<?php echo get_template_directory_uri();?>/images/068-351---Nuttall---D66A0488-p-500.jpeg 500w, <?php echo get_template_directory_uri();?>/images/068-351---Nuttall---D66A0488-p-1080.jpeg 1080w, <?php echo get_template_directory_uri();?>/images/068-351---Nuttall---D66A0488-p-1600.jpeg 1600w, <?php echo get_template_directory_uri();?>/images/068-351---Nuttall---D66A0488.jpg 1920w">
        </div>
        <div class="column-6 w-col w-col-4"><img sizes="(max-width: 767px) 94vw, (max-width: 991px) 229.328125px, 299.984375px" src="<?php echo get_template_directory_uri();?>/images/HOMEPAGE-COMBO-2-WED.jpg" srcset="<?php echo get_template_directory_uri();?>/images/HOMEPAGE-COMBO-2-WED-p-500.jpeg 500w, <?php echo get_template_directory_uri();?>/images/HOMEPAGE-COMBO-2-WED-p-1080.jpeg 1080w, <?php echo get_template_directory_uri();?>/images/HOMEPAGE-COMBO-2-WED-p-1600.jpeg 1600w, <?php echo get_template_directory_uri();?>/images/HOMEPAGE-COMBO-2-WED.jpg 1920w">
        </div>
      </div>
      <div class="row-8 w-row">
        <div class="column-7 w-col w-col-4"><img class="image-56" sizes="(max-width: 767px) 94vw, (max-width: 991px) 229.328125px, 299.984375px" src="<?php echo get_template_directory_uri();?>/images/098-_MG_1599.jpg" srcset="<?php echo get_template_directory_uri();?>/images/098-_MG_1599-p-500.jpeg 500w, <?php echo get_template_directory_uri();?>/images/098-_MG_1599-p-1080.jpeg 1080w, <?php echo get_template_directory_uri();?>/images/098-_MG_1599-p-1600.jpeg 1600w, <?php echo get_template_directory_uri();?>/images/098-_MG_1599.jpg 1920w">
        </div>
        <div class="column-8 w-col w-col-4"><img class="image-57" sizes="(max-width: 767px) 94vw, (max-width: 991px) 229.328125px, 299.984375px" src="<?php echo get_template_directory_uri();?>/images/096-343---Curtis---D66A6202.jpg" srcset="<?php echo get_template_directory_uri();?>/images/096-343---Curtis---D66A6202-p-500.jpeg 500w, <?php echo get_template_directory_uri();?>/images/096-343---Curtis---D66A6202-p-800.jpeg 800w, <?php echo get_template_directory_uri();?>/images/096-343---Curtis---D66A6202-p-1080.jpeg 1080w, <?php echo get_template_directory_uri();?>/images/096-343---Curtis---D66A6202-p-1600.jpeg 1600w, <?php echo get_template_directory_uri();?>/images/096-343---Curtis---D66A6202.jpg 1920w">
        </div>
        <div class="column-9 w-col w-col-4"><img sizes="(max-width: 767px) 94vw, (max-width: 991px) 229.328125px, 299.984375px" src="<?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257.jpg" srcset="<?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-500.jpeg 500w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-800.jpeg 800w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-1080.jpeg 1080w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257-p-1600.jpeg 1600w, <?php echo get_template_directory_uri();?>/images/082-459--Dashwood--_MG_5257.jpg 1920w">
        </div>
      </div>
    </div>
  </div>
